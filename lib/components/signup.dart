      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: 45,
              child: Row( //! toggle only this if there's an error in username or email
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text(
            ...
            SizedBox(
              height: 35,
              child: Row( //! toggle only this if there's an error in password
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text(
                    String.fromCharCode(Iconsax.close_square.codePoint),
